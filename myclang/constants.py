...
MYCLANG_SYSTEM_INCLUDE_ROOT = Path(__file__).parent / "clang_system_include"
MYCLANG_SYSTEM_INCLUDE_CPP = MYCLANG_SYSTEM_INCLUDE_ROOT / "c++" / "v1"
MYCLANG_SYSTEM_INCLUDE_RESOURCE = MYCLANG_SYSTEM_INCLUDE_ROOT / "resource"

MYCLANG_SYSTEM_INCLUDES = [str(MYCLANG_SYSTEM_INCLUDE_CPP), str(MYCLANG_SYSTEM_INCLUDE_RESOURCE)]
