...
mkdir -p /io/myclang/clang_include/compiler

cp -r $LLVM_ROOT/include/c++ /io/myclang/clang_include
cp -r $LLVM_ROOT/lib/clang/11.0.0/include /io/myclang/clang_include/compiler
